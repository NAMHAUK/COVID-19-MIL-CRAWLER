...
public class Crwal_2 {
    ...
    //static String URL_Ulsan="http://ncov.mohw.go.kr/bdBoardList_Real.do?brdId=1&brdGubun=13&ncvContSeq=&contSeq=&board_id=&gubun="; 울산전체
    static String URL_Ulsan ="https://www.ulsan.go.kr/u/health/contents.ulsan?mId=001002003000000000";//울산 울진군
    ...
    //static String contents_Ulsan="#map_city7 .mapview .cityinfo li div"; 울산 전체
    static String contents_Ulsan  = "tr.patient#patient4 td.name";//울산 울진군
    ...
    */
	...
	public static int SearchTag_Type_Ulsan(String to_string, int cheaking) {
		...
		{
			if(((to_string.charAt(i+1) == '<' ||to_string.charAt(i+1) == '(') &&to_string.charAt(i-3)  == '>' && to_string.charAt(i-2)  == '울'&&to_string.charAt(i-1)  == '주' && to_string.charAt(i)  == '군'
							))
			{
				count++;
				}
